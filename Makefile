##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.7.1] date: [Thu May 28 22:34:39 CST 2020] 
##########################################################################################################################
...
Middlewares/Third_Party/RealThread_RTOS_RT-Thread/libcpu/arm/cortex-m7/cpuport.c \
Middlewares/Third_Party/RealThread_RTOS_RT-Thread/components/finsh/shell.c \
Middlewares/Third_Party/RealThread_RTOS_RT-Thread/components/finsh/cmd.c \
Middlewares/Third_Party/RealThread_RTOS_RT-Thread/components/finsh/msh.c \
Core/Src/app.c \
Core/Src/main.c \
...
# mcu
MCU = $(CPU) -mthumb -Wa,-mimplicit-it=thumb $(FPU) $(FLOAT-ABI)
...
#######################################
# list of objects
OBJECTS = $(addprefix $(BUILD_DIR)/,$(patsubst %.c,%.o,$(C_SOURCES)))

# list of ASM program objects
OBJECTS += $(addprefix $(BUILD_DIR)/,$(patsubst %.s, %.o, $(patsubst %.S,%.o,$(ASM_SOURCES))))
